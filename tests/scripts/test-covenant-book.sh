...
if [ "$TEST_ALL_CHAPTERS" = true ]; then
    ...
    if [ $MAIN_RESULT -ne 0 ]; then
        echo -e "${RED}❌ Main covenant test failed${RESET}"
        exit 1
    fi
    ...
    for CHAPTER_NAME in $CHAPTERS; do
        ...
        if [ $CHAPTER_RESULT -ne 0 ]; then
            echo -e "${RED}❌ Chapter $CHAPTER_NAME test failed${RESET}"
            exit 1
        fi
    ...
    echo ""
    echo -e "${GREEN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${RESET}"
    echo -e "${GREEN}✅ All tests passed! (Main + $CHAPTER_COUNT chapters)${RESET}"
    echo -e "${GREEN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${RESET}"
    exit 0
fi
...
echo -e "${GREEN}✅ Rendering successful${RESET}"
echo ""
...
echo ""
echo -e "${GREEN}✅ Covenant book test complete!${RESET}"
