...
**IMPORTANT**: Covenant chart lives in **kast-system/covenant/**, which is the source of truth. Covenant books (configuration data) are located in separate repositories like proto-the-yaml-life. The testing infrastructure in kast-system tests covenant chart with example covenant books.
...
```bash
# 1. List available covenant books (test fixtures in kast-system/bookrack/)
